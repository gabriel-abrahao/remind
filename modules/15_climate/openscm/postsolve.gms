...
*** SOF ./modules/15_climate/openscm/postsolve.gms
...
* TODO Deriving the TIRF from OpenSCM models is not implemented yet
...
*' @stop
*** EOF ./modules/15_climate/openscm/postsolve.gms
