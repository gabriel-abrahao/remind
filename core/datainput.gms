...
/
;
* GA Read choice of non-CO2 MACs 
$ELSEIF.MaccVersion %c_nonco2_macc_version% == "PBL_2019"
* PBL_2019 MACs are discretized in steps of 20 $/tC
sm_dmac = 20 ;
parameter p_abatparam_CH4(tall,all_regi,all_enty,steps)        "MAC costs for CH4 by source"
/
$ondelim
$include "./core/input/p_abatparam_CH4_PBL_2019.cs4r"
$offdelim
/
;
parameter p_abatparam_N2O(tall,all_regi,all_enty,steps)        "MAC costs for N2O by source"
/
$ondelim
$include "./core/input/p_abatparam_N2O_PBL_2019.cs4r"
$offdelim
/
;
...
set macc_scens "MAC scenarios for PBL_2022 MACCs" /Default, Optimistic, Pessimistic/;
...
/
$ondelim
$include "./core/input/p_abatparam_CH4_PBL_2022.cs4r"
$offdelim
/
;
parameter p_abatparam_CH4(tall,all_regi,all_enty,steps) "MAC costs for CH4 by source";
...
/
$ondelim
$include "./core/input/p_abatparam_N2O_PBL_2022.cs4r"
$offdelim
/
;
parameter p_abatparam_N2O(tall,all_regi,all_enty,steps) "MAC costs for N2O by source";
...
* CO2 MACs are treated differently
